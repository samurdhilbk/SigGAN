...
# def Discriminator(load_path):
#     discriminator = keras.models.load_model(load_path)
#     return discriminator

def Discriminator(load_path=None):
    ...
    x = Dense(10, activation='relu',kernel_regularizer = keras.regularizers.l2(0.001))(x)
    x = Dropout(0.5)(x)
    x = Dense(1, activation='sigmoid',kernel_regularizer = keras.regularizers.l2(0.005),name = "sftmx_{}".format(i))(x)
