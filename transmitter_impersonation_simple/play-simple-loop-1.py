...
pickle_path = 'data/pickles/t_10_reward_false_beta_15000_snr_eps.pkl'
dump_pickle_each_loop = True
sensitivity = 0.02
data_pickle = {}
data_pickle["eps"]=[0.2, 0.12, 0.10, 0.08, 0.07, 0.06, 0.05, 0.03, 0.01]
data_pickle["snr"]=[0, 5, 10, 20, 50]
data_pickle["betas"] = [15000]
data_pickle["reward_types"] = [False]
#data_pickle["eps"]=[0.03]
...
#         eps = [0.2, 0.12, 0.10, 0.08, 0.07, 0.06, 0.05, 0.03, 0.01]
#         betas = [15000]
#         reward_types = [True]
        
        eps=data_pickle["eps"]
        betas=data_pickle["betas"]
        reward_types=data_pickle["reward_types"]
