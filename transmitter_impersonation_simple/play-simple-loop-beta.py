...
pickle_path = 'data/pickles/t_10_snr_20_beta_eps_reward_true.pkl'
dump_pickle_each_loop = True
sensitivity = 0.02
data_pickle = {}
#data_pickle["eps"]=[0.2, 0.12, 0.10, 0.08, 0.07, 0.06, 0.05, 0.01]
data_pickle["eps"]=[0.08, 0.07, 0.06, 0.05, 0.03, 0.01]
data_pickle["snr"]=[20]
data_pickle["betas"] = [0, 1000, 5000, 10000, 15000, 20000]
data_pickle["reward_types"] = [True]

for n_authorized in [10]:
    res_t = {}
    for snr in data_pickle["snr"]:
