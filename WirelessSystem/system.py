import numpy as np
import pandas as pd
from WirelessSystem.utils import make_session_dir, store_configuration, generate_symbols, generate_rf_fingerprints, normalize, add_noise, add_non_linearity
...
class RFSystem:
    ...
    def transmit_real_symbol_block(self, symbols, tx_id = 0, authorized = True, impersonator = False):
        ...
        transmitted_symbols_cmplx = self.transmit_symbol_block(symbols_cmplx, tx_id, authorized, impersonator)
